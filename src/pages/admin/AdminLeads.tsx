...
const AdminLeads: React.FC = () => {
  ...
  return (
    <div className="space-y-6 font-poppins">
      <div>
        <h1 className="text-[20px] font-bold text-black uppercase tracking-tight">System Inquiry Leads</h1>
        <p className="text-[12px] text-black font-medium opacity-60 mt-0.5">Track and manage potential buyers inquiring about platform properties.</p>
      </div>
                ...
                <tr key={lead.id} className="hover:bg-gray-50/20 transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                       ...
                       <span className="text-[13px] font-bold text-black">{lead.properties?.title || 'Unknown Property'}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
